...
for (const profile of profiles) {
  ...
  for (const sample of samples) {
    ...
    const isolated = isolatedDocument(head, section, profile.width, profile.height);
